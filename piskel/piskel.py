...
class Personagem(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.sprites = []
        self.sprites.append(pygame.image.load('piskel/sprite_0.png'))
        self.sprites.append(pygame.image.load('piskel/sprite_1.png'))
        self.sprites.append(pygame.image.load('piskel/sprite_2.png'))
        self.atual = 0
